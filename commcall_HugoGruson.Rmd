...
subtitle: "...and how to invite more users to take this jouney"
author: "Hugo Gruson"
...
Different profile than many other active members of the R community
...
will just give up on using the tool
...
[Source](https://github.com/ropensci-org/community-calls/issues/21#issuecomment-767504258)
...
- Make it explicit feedback is valued (and not just virtue signalling)
- Make it less scary to give feedback / contribute
...
## Don't let users work for nothing / feel ignored
...
```{r, echo = FALSE, out.width='75%', fig.align='center', fig.alt=''}
...
- Be easy to find and to contact
- Don't let users work for nothing
- Reduce the workload
- But leave opportunities to learn
